...
if os.getenv('KAGGLE_IS_COMPETITION_RERUN'):
    # Competition rerun — actually solve problems via vLLM on GPU
    inference_server.serve()
else:
    # Save run (non-competition) — just produce a valid submission.parquet.
    # Do NOT call run_local_gateway because it invokes predict() which
    # loads vLLM — that requires GPU and will fail on a CPU save run.
    print("=" * 60)
    ...
    print("To submit: Submit this version to the competition.")
